  ...
  return (
    <>
      <SEO
        ...
        description="Online Quran academy by Qari Sajid Hussain Sialvi. Learn Quran with Tajweed, Salah, Duas and Islamic character building for kids and adults."
      />
        ...
        <div className="container mx-auto grid items-center gap-10 px-4 py-12 sm:px-6 md:px-8 md:py-10 lg:grid-cols-2 lg:gap-6 lg:py-10">
          <Reveal className="order-2 lg:order-1">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3">
              <Link to="/contact" className="w-full sm:w-auto inline-flex justify-center items-center gap-2 rounded-xl bg-gradient-primary px-6 py-3 font-semibold text-primary-foreground shadow-soft transition-smooth hover:-translate-y-0.5 hover:shadow-elegant">
                <GraduationCap className="h-4 w-4" /> Enroll Now
              </Link>
              <Link to="/contact" className="w-full sm:w-auto inline-flex justify-center items-center gap-2 rounded-xl border border-primary/25 bg-white px-6 py-3 font-semibold text-primary shadow-soft transition-smooth hover:-translate-y-0.5 hover:border-primary/50">
            ...
            <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                ...
                <div key={b.t} className="flex items-center gap-3 rounded-2xl bg-white/70 p-3 shadow-soft backdrop-blur">
          ...
          >
            ...
            <div className="overflow-hidden rounded-2xl sm:rounded-[2rem] border border-gold/30 bg-white shadow-elegant">
              <img src={teacherImg} alt="Qari Sajid Hussain Sialvi teaching Quran to students" className="w-full h-[240px] sm:h-[320px] md:h-[420px] lg:h-full object-cover" loading="eager" />
            </div>
          </motion.div>
        </div>
      </section>
            ...
            {[
              ...
              <Reveal key={c.title} delay={i * 0.1}>
                <div className="group h-full rounded-2xl border border-border bg-card p-7 shadow-soft transition-smooth hover:-translate-y-1 hover:shadow-card">
                  <div className={`flex h-14 w-14 items-center justify-center rounded-2xl text-primary-foreground shadow-soft transition-smooth group-hover:scale-110 ${c.color === "gold" ? "bg-gradient-gold" : "bg-gradient-primary"}`}>
